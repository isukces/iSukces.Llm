...
namespace Demo.FunctionCall.QubicSquare;
...
internal static class Program
{
    public static async Task Main(string[] args)
    {
        ...
        await QubicRootDemo(DemoConfig.Model, client, protocol);
    }

    private static async Task QubicRootDemo(string model, LlmClient client, BielikProtocol protocol)
    {
